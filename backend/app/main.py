...
class SecurityHardeningMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request: Request, call_next):
        ...
        response.headers["Content-Security-Policy"] = (
            "default-src 'self'; "
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://checkout.culqi.com https://www.paypal.com https://*.paypalobjects.com https://*.paypal.com https://accounts.google.com; "
