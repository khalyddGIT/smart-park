    ...
    async def _run():
        ...
        async with engine.begin() as conn:
            ...
            pg_adds = [
                ...
                ("estacionamientos", "rate_monthly_auto", "FLOAT DEFAULT 150.0"),
                ("estacionamientos", "rate_monthly_suv", "FLOAT DEFAULT 200.0"),
                ("estacionamientos", "rate_monthly_mototaxi", "FLOAT DEFAULT 100.0"),
                ("estacionamientos", "rate_monthly_moto", "FLOAT DEFAULT 70.0"),
                ("estacionamientos", "rate_monthly", "FLOAT DEFAULT 150.0"),
