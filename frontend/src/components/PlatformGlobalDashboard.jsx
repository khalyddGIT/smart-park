    ...
    <div className="space-y-6">
      ...
      {isRefreshing ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4">
          ...
          <div className="lg:col-span-5 p-5 rounded-3xl border border-slate-200/90 dark:border-slate-800/80 bg-white dark:bg-[#151D2F] shadow-xs flex flex-col justify-between relative overflow-hidden group">
          ...
          <div className="lg:col-span-3 p-5 rounded-3xl border border-slate-200/90 dark:border-slate-800/80 bg-white dark:bg-[#151D2F] shadow-xs flex flex-col justify-between">
          ...
          <div className="lg:col-span-2 p-5 rounded-3xl border border-slate-200/90 dark:border-slate-800/80 bg-white dark:bg-[#151D2F] shadow-xs flex flex-col justify-between">
            <div className="flex items-center justify-between">
